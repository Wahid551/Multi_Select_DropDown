            ...
            children: <Widget>[
              Padding(
                ...
                child: RaisedButton(
                  ...
                  color: Colors.black,
                  child: Text(
                    'Click Here for Another Method of Multiselect Values',
              ...
              Padding(
                ...
                child: new MultiSelect(
                  ...
                  checkBoxColor: Theme.of(context).primaryColorLight,
                  cancelButtonColor: Theme.of(context).primaryColorLight,
                  searchBoxFillColor: Colors.grey,
                  searchBoxHintText: "Search country",
                ),
              ),
              SizedBox(
                width: 10.0,
